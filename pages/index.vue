    ...
    <main class="m-auto p-6 max-w-5xl">
        <div class="flex w-full items-center mb-8">
            <div class="inline-flex w-1/2 justify-start">
                <h1 class="whitespace-pre-line text-2xl">Hello!
        ...
        <div class="alert alert-warning shadow-lg rounded-md mb-4">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
                <span>Warning: This could be a scam!</span>
            </div>
        </div>
        <h2 class="mb-6 font-semibold text-lg">Non Cash Services</h2>
